        ...
        <div class="right d-flex flex-column">
          ...
          <v-card-text>
            ...
            <v-form ref="form">
              ...
              <p class="white--text mt-4">If you don't have an account, <router-link class="text-decoration-none text-primary font-weight-bold" to="/login">Register</router-link> first</p>
            </v-form>
          </v-card-text>
        </div>
      </v-card>
